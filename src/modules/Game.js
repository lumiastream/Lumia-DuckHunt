...
class Game {
    ...
    startLumiaSdk() {
        LumiaSdkManager.getInstance().on('command', ({ gamesGlowKey, value }) => {
            switch (gamesGlowKey) {
                case GamesGlowCommandKeys.GIVE_BULLET:
    ...
    updateScore(ducksShot) {
        ...
        LumiaSdkManager.SendVariable({ gamesGlowKey: GamesGlowVariableKeys.SCORE, value: this.score });
    }

...
class Stage extends Container {
     ...
     */
    _setStage() {
        const background = new extras.AnimatedSprite([loader.resources[this.spritesheet].textures['scene/back/0.png']]);
    ...
    clickedPauseLink(clickPoint) {
        ...
        return (
            _inRange(scaledClickPoint.x, HUD_LOCATIONS.PAUSE_LINK.x - 110, HUD_LOCATIONS.PAUSE_LINK.x) && _inRange(scaledClickPoint.y, HUD_LOCATIONS.PAUSE_LINK.y - 30, HUD_LOCATIONS.PAUSE_LINK.y + 10)
        );
    }
    ...
    clickedFullscreenLink(clickPoint) {
        const scaledClickPoint = this.getScaledClickLocation(clickPoint);
        return (
            _inRange(scaledClickPoint.x, HUD_LOCATIONS.FULL_SCREEN_LINK.x - 110, HUD_LOCATIONS.FULL_SCREEN_LINK.x) &&
    ...
    clickedMuteLink(clickPoint) {
        const scaledClickPoint = this.getScaledClickLocation(clickPoint);
        return _inRange(scaledClickPoint.x, HUD_LOCATIONS.MUTE_LINK.x - 110, HUD_LOCATIONS.MUTE_LINK.x) && _inRange(scaledClickPoint.y, HUD_LOCATIONS.MUTE_LINK.y - 30, HUD_LOCATIONS.MUTE_LINK.y + 10);
    }
